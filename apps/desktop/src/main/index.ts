import { config } from 'dotenv';import {
  app,
  BrowserWindow,
  shell,
  ipcMain,
...
titleBarStyle: process.platform === "darwin" ? "hiddenInset" : "default",    trafficLightPosition: { x: 16, y: 16 },
    webPreferences: {
      preload: preloadPath,
...
if (!app.isPackaged && !isE2EMode) {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    console.log("[Main] Loading from file:", indexPath);    mainWindow.loadFile(indexPath);
  }
}
