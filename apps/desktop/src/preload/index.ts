...
openExternal: (url: string): Promise<void> =>
  ...
  clearTaskHistory: (): Promise<void> =>
    ipcRenderer.invoke("task:clear-history"),  getTodosForTask: (taskId: string): Promise<TodoItem[]> =>
...
taskId?: string
  ...
  getOpenAiBaseUrl: (): Promise<string> =>
    ipcRenderer.invoke("settings:openai-base-url:get"),  setOpenAiBaseUrl: (baseUrl: string): Promise<void> =>
...
hasApiKey: (): Promise<boolean> => ipcRenderer.invoke("api-key:exists"),
  ...
  getOnboardingComplete: (): Promise<boolean> =>
    ipcRenderer.invoke("onboarding:complete"),  setOnboardingComplete: (complete: boolean): Promise<void> =>
...
} | null> => ipcRenderer.invoke('model:get'),  setSelectedModel: (model: {
    provider: string;
    model: string;
    baseUrl?: string;
    deploymentName?: string;
...
authType: "api-key" | "entra-id";
  ...
  testAzureFoundryConnection: (config: {
    endpoint: string;
    deploymentName: string;
authType: 'api-key' | 'entra-id';    apiKey?: string;
  }): Promise<{
    success: boolean;
    error?: string;
...
ipcRenderer.invoke("bedrock:validate", credentials),
  ...
  getProviderSettings: (): Promise<unknown> =>
    ipcRenderer.invoke("provider-settings:get"),  setActiveProvider: (providerId: string | null): Promise<void> =>
...
ipcRenderer.invoke("skills:get-content", id),
  pickSkillFile: (): Promise<string | null> =>
    ipcRenderer.invoke("skills:pick-file"),  addSkillFromFile: (filePath: string): Promise<Skill> =>
