...
1. **Define the question**: Clarify what information is needed
2. **Search**: Use browser to search multiple sources
3. **Gather**: Collect relevant information from trusted sources
4. **Verify**: Cross-reference facts across sources
5. **Summarize**: Present findings in a clear format
